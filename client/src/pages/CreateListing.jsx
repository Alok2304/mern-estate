...
export default function CreateListing() {
	...
	const handleImageSubmit = () => {
		if (files.length > 0 && files.length + formData.imageUrls.length < 7) {
			...
			setImageUploadError("You can upload maximum of 6 images at once");
			setUploading(false);
		}
	};
		...
		return new Promise((resolve, reject) => {
			...
			uploadTask.on(
				...
				(snapshot) => {
					...
					console.log(`Upload is now ${progress}% done.`);
				},
				(error) => {
					reject(error);
				},
				...
				<div className="flex flex-col flex-1 gap-4">
					...
					<div className="flex gap-4">
						...
						<button
							...
							disabled={uploading}
							type="button"
							className="p-3 text-white border bg-green-500 rounded uppercase hover:shadow-lg disabled:opacity-80"
						>
